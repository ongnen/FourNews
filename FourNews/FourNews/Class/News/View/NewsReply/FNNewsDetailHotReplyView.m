...
- (void)setReplyArray:(NSArray *)replyArray
{
    ...
    sglReplyV1.frame = CGRectMake(0, 30, self.frame.size.width, sglReplyV1.totalHeight);
    [self addSubview:sglReplyV1];
    
    _totalHeight = sglReplyV1.frame.size.height+sglReplyV1.frame.origin.y+FNNewsReplyMargin+40;
    ...
    sglReplyV2.frame = CGRectMake(0, sglReplyV1.frame.size.height+sglReplyV1.frame.origin.y+FNNewsReplyMargin, self.frame.size.width, sglReplyV2.totalHeight);
    ...
    _totalHeight = sglReplyV2.frame.size.height+sglReplyV2.frame.origin.y+FNNewsReplyMargin+40;
    ...
    sglReplyV3.frame = CGRectMake(0, sglReplyV2.frame.size.height+sglReplyV2.frame.origin.y+FNNewsReplyMargin, self.frame.size.width, sglReplyV3.totalHeight);
    ...
    _totalHeight = sglReplyV3.frame.size.height+sglReplyV3.frame.origin.y+FNNewsReplyMargin+40;
}
